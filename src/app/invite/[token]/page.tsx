...
export default function InviteSignupPage() {
  const { user, token, signUpWithEmail, signInWithEmail, signInWithGoogle, refreshUser, loading: authLoading } = useAuth();
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            disabled={submitting}
            className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-6 py-3 text-gray-700 dark:text-gray-200 font-medium hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 transition-all"
          >
